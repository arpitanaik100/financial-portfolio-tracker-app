...
import Addstocks from '../Components/Addstocks/Addstocks';
 ...
 class Main extends Component {
     ...
     componentDidMount(){
        axios.get("https://financial-portfolio-trac-74bd5.firebaseio.com/companies.json")
        .then((response)=>{
        ...
        axios.get("https://financial-portfolio-trac-74bd5.firebaseio.com/mystocks.json")
        .then((response)=>{
    ...
    removeStock=(index)=>{
        ...
        let companySymbol=this.state.myStocks[index]["Company_Symbol"];
            ...
            axios.post('https://financial-portfolio-trac-74bd5.firebaseio.com/companies.json', {
                name:companyName,
            ...
            //Deleting stocks from my Stocks
             axios.delete(`https://financial-portfolio-trac-74bd5.firebaseio.com/mystocks/${id}.json`)
             .then((response)=>{
        ...
        addDatatoFirebase=(a,b,c)=>
        {
            ...
            let buyDate=document.getElementById("buyDate").value;
                    if(noofshares>0&&buyPrice.length>0&&buyDate.length>0)
                    {
                            ...
                            axios.post('https://financial-portfolio-trac-74bd5.firebaseio.com/mystocks.json', {
                            ...
                            axios.delete(`https://financial-portfolio-trac-74bd5.firebaseio.com/companies/${id}.json`)
                            .then((response)=>{
